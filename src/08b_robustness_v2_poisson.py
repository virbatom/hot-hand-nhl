# 08b_robustness_v2_poisson.py

"""
Robustness v2: All checks now include score-state controls (the R1 finding) - POISSON ONLY.
...
print("=" * 72)
print("ALL MODELS INCLUDE SCORE-STATE CONTROLS (is_leading, is_trailing) [POISSON]")
print("=" * 72)
...
r = run_poisson(panel_placebo, season_dummies, label="Random treatment (seed=296)")
...
r = run_poisson(panel_placebo, season_dummies, label="Random treatment (seed=185)")
...
r = run_poisson(panel_placebo, season_dummies, label="Random treatment (seed=142)")
...
# Summary
print("\n" + "=" * 72)
print("ROBUSTNESS SUMMARY (POISSON ONLY - all with score-state controls)")
print("=" * 72)
